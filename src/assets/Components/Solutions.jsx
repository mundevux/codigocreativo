            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                ...
                <div className="space-y-6 text-gray-600 md:flex  md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
                    ...
                    <div className="md:7/12 lg:w-1/2">
                        ...
                        <p className="my-8 text-gray-600 dark:text-gray-300">En nuestra agencia ofrecemos una amplia gama de servicios para ayudarte a mejorar tu presencia en línea. Desde el diseño y desarrollo de sitios web hasta la optimización de motores de búsqueda y la gestión de redes sociales, nuestro equipo está capacitado para ofrecerte soluciones personalizadas que se adaptan a tus necesidades específicas. Ya sea que estés buscando aumentar tus ventas o mejorar tu imagen de marca, estamos aquí para ayudarte.</p>
                            </div>
                    </div>
